			...
			<div class="container">
				<div class="copy-content">
					...
					if ( ! empty( $footer_copyright_text ) ) {
						...
						printf( esc_html__( '%1$s %2$s by %3$s', 'grace-mag' ), wp_kses_post( $footer_copyright_text ), 'Grace Mag', '<a href="' . esc_url( 'https://everestthemes.com' ) . '">Everestthemes</a>' );
					} else {
