...
if( ! class_exists( 'Grace_Mag_Author_Widget' ) ) {
    
    class Grace_Mag_Author_Widget extends WP_Widget {
 
        function __construct() { 

            parent::__construct(
                'grace-mag-author-widget',  // Widget ID
                esc_html__( 'GM: Author Widget', 'grace-mag' ),   // Widget Name
                array(
                    'description' => esc_html__( 'Displays brief author detail.', 'grace-mag' ), 
                )
            );
                       ...
                       <?php
                        ...
                        <div class="widget-container">
                            ...
                            <div class="author-thumb">
                                <?php
                                $thumbnail_url = get_the_post_thumbnail_url( get_the_ID(), 'grace-mag-thumbnail-two' );
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_id( 'author_page' ) )?>"><strong><?php esc_html_e( 'Author Page', 'grace-mag' ); ?></strong></label>
                <?php
                    wp_dropdown_pages( array(
                        ...
                        'show_option_none' => esc_html__( '&mdash; Select Page &mdash;', 'grace-mag' ),
                        )
                    );
                ?>
            </p>
            ...
            <p>
                <label for="<?php echo esc_attr( $this->get_field_name('author_link_title') ); ?>">
                    <strong><?php esc_html_e('Author Page Link Title', 'grace-mag'); ?></strong>
                </label>
