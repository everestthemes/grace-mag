...
if ( ! function_exists( 'grace_mag_setup' ) ) :
	...
	function grace_mag_setup() {
		...
		add_theme_support(
			'custom-background',
			apply_filters(
				'grace_mag_custom_background_args',
				array(
...
function grace_mag_admin_enqueue_script() {
	...
	wp_enqueue_style( 'grace-mag-admin-style', get_template_directory_uri() . '/everestthemes/admin/css/gm-admin-style.css', array(), $theme_version );
...
function grace_mag_scripts() {
	...
	wp_enqueue_style( 'grace-mag-style', get_stylesheet_uri(), array(), $theme_version );

	wp_enqueue_style( 'grace-mag-google-fonts', grace_mag_fonts_url(), array(), $theme_version );

	wp_enqueue_style( 'grace-mag-reset', get_template_directory_uri() . '/everestthemes/assets/css/reset.css', array(), $theme_version );

	if ( is_rtl() ) {

		wp_enqueue_style( 'bootstrap-rtl', get_template_directory_uri() . '/everestthemes/assets/css/bootstrap-min-rtl.css', array(), $theme_version );
	} else {

		wp_enqueue_style( 'bootstrap', get_template_directory_uri() . '/everestthemes/assets/css/bootstrap.min.css', array(), $theme_version );
	}

	wp_enqueue_script( 'grace-mag-theia-sticky-sidebar', get_template_directory_uri() . '/everestthemes/assets/js/theia-sticky-sidebar.js', array( 'jquery' ), $theme_version, true );

	wp_enqueue_style( 'font-awesome', get_template_directory_uri() . '/everestthemes/assets/css/font-awesome.min.css', array(), $theme_version );

	wp_enqueue_style( 'slick', get_template_directory_uri() . '/everestthemes/assets/css/slick.css', array(), $theme_version );

	wp_enqueue_style( 'webticker', get_template_directory_uri() . '/everestthemes/assets/css/webticker.css', array(), $theme_version );

	wp_enqueue_style( 'grace-mag-custom', get_template_directory_uri() . '/everestthemes/assets/css/custom.css', array(), $theme_version );

	wp_enqueue_style( 'grace-mag-default-style', get_template_directory_uri() . '/everestthemes/assets/css/default-style.css', array(), $theme_version );

	wp_enqueue_style( 'grace-mag-responsive', get_template_directory_uri() . '/everestthemes/assets/css/responsive.css', array(), $theme_version );
